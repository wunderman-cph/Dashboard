...
<html> 
  ...
  <script>
    ...
    function logfile(f,obj) {
      $.repeat(1000, function() {
        $.get('log.php?file='+f, function(data) {
          $(obj).append(data);
        });
      });
    });
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-md-12">          
            <ol>
              <li>Status of AEM (Up, Loading etc)</li>
              <li>Turn on and off each instance</li>
              <li>Memory being used by each instance</li>
            </ol>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="nav-tabs-custom" style="cursor: move;">
              ...
              <ul class="nav nav-tabs pull-right ui-sortable-handle">
                <li class=""><a href="#publish" data-toggle="tab" aria-expanded="true">Publish</a></li>
                <li class="active"><a href="#author" data-toggle="tab" aria-expanded="false">Author</a></li>
                
                <li class="pull-left header"><i class="fa fa-file-text"></i>Logs</li>
              </ul>
              <div class="tab-content">
                <!-- Author -->
                <div class="tab-pane active" id="author" style="min-height: 300px;">

                    <script>
                        $(function() {
                          
                          $.repeat(1000, function() {
                            $.get('log.php?file=/opt/aem/author/crx-quickstart/logs/error.log', function(data) {
                              $('#pdump').append(data);
                            });
                          });
                        });
                    ...
                    <?php
                     /* $output = shell_exec("tail -n50 /opt/aem/author/crx-quickstart/logs/error.log 2>&1");
                     echo $output; */
                    ?>
                    

                </div>
                <div class="tab-pane" id="publish" style="min-height: 300px;"></div>
              </div>
            </div>
          </div>
        </div>
