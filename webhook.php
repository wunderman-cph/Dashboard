  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">            
            <div class="col-md-12">
              <p>API Endpoint: <strong>http://api.webhookinbox.com/i/hLvk6gbE/in/</strong></p>
    ...
    <!-- Optionally, you can add Slimscroll and FastClick plugins.
     ...
     setInterval(function(){ doPoll(); }, 1000);
      ...
      function doPoll(){
        $.get('http://api.webhookinbox.com/i/hLvk6gbE/items/?order=created&since=id:'+last_cursor, function(data) {
